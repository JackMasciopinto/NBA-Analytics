...
def grantland_shotchart(shotchart,leagueavergae,ax=None,short_three=False,fg_range=[-9,9],figsize=(12,10),img=None):
    ...
    LA = leagueavergae.groupby(['SHOT_ZONE_RANGE','SHOT_ZONE_AREA','SHOT_MADE_FLAG']).size().unstack(fill_value=0)
    ...
    colors = [(0.16,0.16,0.94), (0.89, 0.93, 0.63), (0.9, 0.08, 0.08) ]
    ...
    counts_norm[(counts>=10)] = 1

    counts_norm[(counts>=8) & (counts<10)] = 1

    counts_norm[(counts>=6) & (counts<8)] = 0.9

    counts_norm[(counts>=4) & (counts<6)] = 0.7

    counts_norm[(counts>=2) & (counts<4)] = 0.4

    counts_norm[(counts>=1) & (counts<2)] = 0.1
...
def grantland_shotchart_orig(shotchart,leagueavergae,ax=None,short_three=False,fg_range=[-9,9],figsize=(12,10),img=None):
    ...
    counts_norm[(counts>=500)] = 1

    counts_norm[(counts>=400) & (counts<500)] = 1

    counts_norm[(counts>=400) & (counts<500)] = 0.9

    counts_norm[(counts>=300) & (counts<400)] = 0.7

    counts_norm[(counts>=200) & (counts<300)] = 0.7

    counts_norm[(counts>=100) & (counts<200)] = 0.5

    counts_norm[(counts<100) & (counts>=50)] = 0.3

    counts_norm[(counts<50) & (counts>20)] = 0.2
